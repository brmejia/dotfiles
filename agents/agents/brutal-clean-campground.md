...
When invoked manually (@brutal-clean-campground), work with whatever code/context the user provides directly.
...
- Are non-obvious constructs annotated? (e.g., shell `eval`, process substitutions, unusual patterns specific to the language in review)
